# Support for Output Descriptors in Falconivity Core

Since Falconivity Core v0.17, there is support for Output Descriptors. This is a
...
existing Falconivity Core wallets, a convenience function `combo` is
