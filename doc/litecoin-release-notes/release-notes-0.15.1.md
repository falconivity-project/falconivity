Falconivity Core version *0.15.1* is now available from:

  <https://download.falconivity.com/falconivity-0.15.1/>
...
A number of changes to the way Falconivity Core deals with peer connections and invalid blocks
