...
"""Verify that starting falconivity with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start falconivity with -h for help text")
        ...
        self.log.info("Start falconivity with -version for version information")
        ...
        self.log.info("Start falconivityd with -fakearg to make sure it does not start")
