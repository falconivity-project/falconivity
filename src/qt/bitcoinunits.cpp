...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FCSC");
    case mBTC: return QString("falconies");
    case uBTC: return QString("photons");
    case SAT: return QString("falcoshi");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Falconovities");
    case mBTC: return QString("Falconies (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Photons (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case SAT: return QString("Falcoshis (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
