...
{
    const char* pszTimestamp = "When life gives you lemons, make lemonade";
    const CScript genesisOutputScript = CScript() << ParseHex("247776712fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1646311182, 2000863203, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4f4109d9b626ee66d900a3bf278c8bab051460042eaf52b384e087dc8bc54f41"));
        assert(genesis.hashMerkleRoot == uint256S("0x7b7c10b024445cc990f9846431024a9430e04785f51f713bcba55b58c7c1b5ee"));
        ...
        vSeeds.emplace_back("108.61.164.55");
        //vSeeds.emplace_back("dnsseed.falconivity.com");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x4f4109d9b626ee66d900a3bf278c8bab051460042eaf52b384e087dc8bc54f41")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1646311182, 2423669, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4233b64a0d5f6495b8e22f8676ca5243a3c4bab761f42f606052106921f9b1abs"));
        assert(genesis.hashMerkleRoot == uint256S("0x7b7c10b024445cc990f9846431024a9430e04785f51f713bcba55b58c7c1b5ee"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x4233b64a0d5f6495b8e22f8676ca5243a3c4bab761f42f606052106921f9b1ab")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1646311182, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x95e8458f9c52f06b20176af7ed0f5aa6be1ae664e44ac2669048527c02a0e38a"));
        assert(genesis.hashMerkleRoot == uint256S("0x7b7c10b024445cc990f9846431024a9430e04785f51f713bcba55b58c7c1b5ee"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x95e8458f9c52f06b20176af7ed0f5aa6be1ae664e44ac2669048527c02a0e38a")},
            }
        };
