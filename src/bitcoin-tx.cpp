...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " falconivity-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  falconivity-tx [options] <hex-tx> [commands]  Update hex-encoded falconivity transaction\n" +
            "or:     falconivity-tx [options] -create [commands]   Create hex-encoded falconivity transaction\n" +
            "\n";
