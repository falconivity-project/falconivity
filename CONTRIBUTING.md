Contributing to Falconivity Core
============================

The Falconivity Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Falconivity Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/falconivity-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to falconivity-qt
...
The following applies to code changes to the Falconivity Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Falconivity
Network Protocol consensus changes.

Whether a pull request is merged into Falconivity Core rests with the project merge
...
Patches that change Falconivity consensus rules are considerably more involved than
...
Where a patch set proposes to change the Falconivity consensus, it must have been
...
The project leader is the release manager for each Falconivity Core release.
